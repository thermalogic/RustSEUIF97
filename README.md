...
SEUIF97 achieves **1.9 - 6.7x speedups** over [CoolProp IF97](https://github.com/CoolProp/IF97). See [Performance Comparison: SEUIF97 vs CoolProp IF97](./docs/seuif97_coolprop_if97.md) for detailed benchmark results.
