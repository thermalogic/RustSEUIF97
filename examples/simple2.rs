//! rustc -O simple2.rs --extern if97=../target/release/libif97.rlib
//! The simple demo to get all properties 
#![allow(warnings)]
fn main() {
    let prop_map: [(&str, i32);20]=[
        ...
        ("cv Specific isochoric heat capacity(kJ/(kg·K))", if97::OCP),
