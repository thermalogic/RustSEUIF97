...
fn criterion_benchmark(c: &mut Criterion) {
   ...
   // group.bench_function("ph2t_reg5", |b| b.iter(|| ph(black_box(0.5), black_box( 4527.49310), OT)));
    ...
    //group.bench_function("ps2t_reg1", |b| b.iter(|| ps(black_box(3.0), black_box( 0.392294792), OT)));
      group.bench_function("ps2t_reg2", |b| b.iter(|| ps(black_box(0.0035), black_box(8.5224), OT)));
   ...
   // group.bench_function("pv2t_reg3", |b| b.iter(|| pv(black_box(0.222930643E2), black_box( 0.002), OT)));
