...
\begin{keywords}
IAPWS-IF97; Thermodynamic properties; Loop tiling; Shared-power scaling; Performance optimization
\end{keywords}
...
In Regions 1--3, all optimizations combine. Entropy $s$ calculations reach 24.1--30.2x because shared-power scaling eliminates redundant power calculations while loop tiling improves cache locality for the large polynomial sums. Enthalpy $h$ cases (14.1--29.9x) are lower because only loop tiling is active.
