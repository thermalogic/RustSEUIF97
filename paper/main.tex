...
maintaining full formula accuracy:
   ...
   1.9x to 6.7x speedups over CoolProp IF97, the most widely used open-source implementation, with the largest improvements in Regions 1, 2, and 3.
\end{abstract}
...
\midrule
$(p,T)\!\rightarrow\!h$ & 1 & 3.0 MPa, 300 K & 136.1 & 42.6 & 3.2x \\
$(p,T)\!\rightarrow\!s$ & 1 & 3.0 MPa, 300 K & 255.5 & 45.8 & 5.6x \\
$(p,T)\!\rightarrow\!h$ & 2 & 0.0035 MPa, 300 K & 188.0 & 48.8 & 3.9x \\
$(p,T)\!\rightarrow\!s$ & 2 & 0.0035 MPa, 300 K & 381.9 & 56.8 & 6.7x \\
$(T,v)\!\rightarrow\!h$ & 3 & 650 K, 0.002 m$^3$/kg & 203.6 & 106.7 & 1.9x \\
$(T,v)\!\rightarrow\!s$ & 3 & 650 K, 0.002 m$^3$/kg & 212.8 & 107.4 & 2.0x \\
$(p,T)\!\rightarrow\!h$ & 5 & 0.5 MPa, 1500 K & 32.0 & 10.9 & 2.9x \\
$(p,T)\!\rightarrow\!s$ & 5 & 0.5 MPa, 1500 K & 56.9 & 17.4 & 3.3x \\
\bottomrule
\end{tabular}
\end{table}
