...
but direct formula evaluation cannot meet the compute-intensive demands of large-scale simulations requiring millions of property calculations. Existing approaches to improve computational speed fall into two categories: 
 (1) direct formula evaluation with fast integer power functions (repeated squaring), which provides limited acceleration; and
  ...
  input parameter pairs. This paper presents two acceleration techniques that directly optimize the IAPWS-IF97 formula evaluation:
   ...
   eliminating redundant calculations. These techniques maintain full formula accuracy while supporting all 12 input parameter pairs. 
   A Rust-based software package, SEUIF97, implements these methods and computes 36 thermodynamic, transport, and derived properties. 
