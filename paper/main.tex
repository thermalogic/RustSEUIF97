...
\begin{itemize}
    ...
    such as $s$ (which requires $\gamma_\tau$,$\gamma$) and $w$ (which requires $\gamma_\pi$, $\gamma_{\pi\pi}$, $\gamma_{\pi\tau}$, $\gamma_{\tau\tau}$). The shared-power scaling technique computes all required derivatives simultaneously, eliminating redundant power calculations.
\end{itemize}
...
The shared-power scaling technique is applicable to any computational problem where a function and its derivatives share the same base power terms.
