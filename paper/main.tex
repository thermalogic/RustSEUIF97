...
maintaining full formula accuracy:
   ...
   Benchmark results demonstrate 5x to 36x speedups over baseline implementations and 14x to 30x speedups over CoolProp IF97, with the largest improvements in Regions 1, 2, and 3.
\end{abstract}
