...
* [1.1.5](https://crates.io/crates/if97/1.1.5) -  The multi-step method unleashes the full power of the compiler optimizations while using `powi()` with the `for` loop
