...
//! Page25,Page30 Eq 9: https://iapws.org/documents/release/Supp-phs3-2014
...
pub fn hs2T_reg43(h: f64, s: f64) -> f64 {
    ...
    let tiles: [(usize, usize); 2] = [(0, 18), (18,36)];
    550.0* poly_powi_tile(nu, sigma, &IJn, &tiles)
