...
pub fn pv2T_reg5(p: f64, v: f64) -> f64 {
   ...
   //     (v - pT2v_reg5(p, T)) / v
    ...
    zbrent(pT2v_reg5, p, v, T1, T2, FIRST_FIXED, MAX_ITER, CONVERGENCE_PRECISION)  
}
...
pub fn Tv2p_reg5(T: f64, v: f64) -> f64 {
    ...
    //zbrent(pT2v_reg5, T, v, p1, p2, SECOND_FIXED, MAX_ITER, CONVERGENCE_PRECISION)  
}
...
pub fn Th2p_reg5(T: f64, h: f64) -> f64 {
    let p1: f64 = P_MIN5;
    let p2: f64 = P_MAX5; //
    rtsec(pT2h_reg5, T, h, p1, p2, SECOND_FIXED, MAX_ITER, CONVERGENCE_PRECISION)
}
...
pub fn Ts2p_reg5(T: f64, s: f64) -> f64 {
    let p1: f64 = P_MIN5;
    let p2: f64 = P_MAX5;
    rtsec(pT2s_reg5, T, s, p1, p2, SECOND_FIXED, MAX_ITER, CONVERGENCE_PRECISION)
}
