...
// Table 38. Numerical values of the coefficients and exponents of the
// residual part r of the dimensionless Gibbs free energy for region 5, Eq.(34)
//--------------------------------------------------------------------------------------
...
// derivatives a according to Eq. (34)
