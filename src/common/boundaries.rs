...
pub fn h2p_sat_reg3(h: f64) -> f64 {
    ...
    let nu: f64 = h / 2600.0;
    let mut suma: f64 = poly(nu - 1.02, nu - 0.608, &IJn);
    22.0 * suma
}
...
pub fn s2p_sat_reg3(s: f64) -> f64 {
    ...
    let sigma: f64 = s / 5.2;
    let mut suma: f64 = poly(sigma - 1.03, sigma - 0.699, &IJn);
    22.0 * suma
}
...
pub fn hs_region_h1_s(s: f64) -> f64 {
    ...
    let sigma: f64 = s / 3.8;
    let mut suma: f64 = poly(sigma - 1.09, sigma + 0.366e-4, &IJn);
    1700.0 * suma
}
...
pub fn hs_region_h2ab_s(s: f64) -> f64 {
    ...
    let mut suma: f64 = poly(1.0 / sigma1, sigma2, &IJn);
    2800.0 * suma.exp()
}
...
pub fn hs_region_h2c3b_s(s: f64) -> f64 {
    ...
    let sigma: f64 = s / 5.9;
    let mut suma: f64 = poly(sigma - 1.02, sigma - 0.726, &IJn);
    2800.0 * suma.powi(4)
}
...
pub fn hs_region_h13_s(s: f64) -> f64 {
    ...
    let sigma: f64 = s / 3.8;
    let mut suma: f64 = poly(sigma - 0.884, sigma - 0.864, &IJn);
    1700.0 * suma
}
...
pub fn hs_region_t_hs(h: f64, s: f64) -> f64 // _t23_hs(h, s)
{
    ...
    let nu: f64 = h / 3000.0;
    let sigma: f64 = s / 5.3;
    let mut suma: f64 = poly(nu - 0.727, sigma - 0.864, &IJn);
    900.0 * suma
}
