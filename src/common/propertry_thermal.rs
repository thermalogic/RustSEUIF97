...
pub fn pv_thermal(p: f64, v: f64, o_id: i32) -> f64 {
    pair_thermal(
        p,
        v,
        o_id,
...
pub fn tv_thermal(t: f64, v: f64, o_id: i32) -> f64 {
    pair_thermal(
        t,
        v,
        o_id,
...
pub fn th_thermal(t: f64, h: f64, o_id: i32) -> f64 {
    pair_thermal(
        t,
        h,
        o_id,
...
pub fn ts_thermal(t: f64, s: f64, o_id: i32) -> f64 {
    pair_thermal(
        t,
        s,
        o_id,
