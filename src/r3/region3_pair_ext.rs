...
pub fn pv2T_reg3(p: f64, v: f64) -> f64 {
    ...
    let d: f64 = 1.0 / v;
    rtsec(Td2p_reg3, d, p, T1, T2, 2, ESP, I_MAX)
    //zbrent(Td2p_reg3, d, p, T1, T2, 2, ESP, I_MAX) 
}
...
pub fn Th2d_reg3(T: f64, h: f64) -> f64 {
    ...
    rtsec(Td2h_reg3, T, h, d1, d2, 1, ESP, I_MAX)
    //zbrent(Td2h_reg3, T, h, d1, d2, 1, ESP, I_MAX) 
}
...
pub fn Ts2d_reg3(T: f64, s: f64) -> f64 {
    ...
    //zbrent(Td2s_reg3, T, s, d1, d2, 1, ESP, I_MAX) 
}
